...
import { 
  ...
  ChevronRight, Sparkles, Globe, Shield, BadgeCheck, ArrowBigUp, ArrowBigDown
} from 'lucide-react';
                      ...
                      <div className={styles.articleMeta}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.2rem', color: '#ff4b4b' }}>
                                   <ArrowBigDown size={18} strokeWidth={1.5} />
                                   <span style={{ fontSize: '0.75rem', fontWeight: 900 }}>{idea.status?.downvotes || 0}</span>
                                </div>
                            </div>
