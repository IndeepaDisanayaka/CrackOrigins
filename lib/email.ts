...
export async function sendPasswordResetEmail(to: string, code: string, name: string) {
    try {
        const html = `
            <div style="background-color: #0c0c12; color: #ffffff; font-family: 'Roboto', Helvetica, Arial, sans-serif; padding: 40px 20px; text-align: center; border-radius: 12px; max-width: 600px; margin: 0 auto; border: 1px solid #FFD700;">
                <div style="margin-bottom: 30px;">
                    <h1 style="color: #FFD700; font-size: 28px; font-weight: 900; letter-spacing: 2px; margin: 0; text-transform: uppercase;">CRACK ORIGINS</h1>
                    <p style="color: rgba(255,255,255,0.6); font-size: 12px; margin-top: 5px; font-weight: 700; letter-spacing: 1px;">PASSWORD RECOVERY SYSTEM</p>
                </div>
                
                <div style="background: rgba(255, 215, 0, 0.05); border: 1px solid rgba(255, 215, 0, 0.2); padding: 30px; border-radius: 8px; margin-bottom: 30px; text-align: left;">
                    <h2 style="font-size: 18px; font-weight: 700; margin-bottom: 20px; color: #ffffff; text-transform: uppercase;">Password Reset Verification</h2>
                    <p style="font-size: 14px; color: rgba(255,255,255,0.8); line-height: 1.6; margin-bottom: 25px;">
                        Hello <strong>${name}</strong>,<br><br>
                        We received a request to reset your password. Use the verification code below to authorize the change.
                    </p>
                    
                    <div style="background: #1e1e26; color: #FFD700; font-size: 42px; font-weight: 900; padding: 20px; border-radius: 4px; letter-spacing: 10px; font-family: 'Courier New', Courier, monospace; border: 1px solid #33333f; display: block; text-align: center;">
                        ${code}
                    </div>
